            ...
            new Thread() {
                ...
                public void run() {
                    try {
                        ...
                        midlet.imageCaptured1(pngImage);
...
//                        midlet.img=image;
                        midlet.data11 = pngImage;
                        midlet.form3.delete(0);
                        image = createThumbnail(image);
                        ImageItem imageitem = new ImageItem("", image, ImageItem.LAYOUT_TOP | ImageItem.LAYOUT_RIGHT, null);
                        midlet.form3.insert(0, imageitem);
                        
                        Display.getDisplay(midlet).setCurrent(midlet.form3);
                    //discardPlayer();
                    } catch (MediaException me) {
//                        midlet.showError("MediaException: " + me.getMessage());
                    } catch (SecurityException se) {
